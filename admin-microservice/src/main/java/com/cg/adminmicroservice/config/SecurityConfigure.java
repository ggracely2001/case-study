package com.cg.adminmicroservice.config;
...
public class SecurityConfigure extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.csrf().disable()
		.authorizeRequests().antMatchers("/v3/api-docs/**","/api/admins/reg","/api/admins/authenticate","/api/admins/**").permitAll().anyRequest().authenticated()
