...
class CourseServiceImplTest {
    ...
    void saveCourse_Test() {
        CourseDto courseDto = new CourseDto(1L, "Course1", "CS101", LocalDate.now(), LocalDate.now().plusDays(30), "Mentor1", 50f,LocalDateTime.now(),1f,50L);
        Course mockCourse = new Course(1L, "Course1", "CS101", LocalDate.now(), LocalDate.now().plusDays(30), "Mentor1", 50f,LocalDateTime.now(),1f,50L);
    ...
    void getCourseById_Test() {
        Long courseId = 1L;
        Course mockCourse = new Course(courseId, "Course1", "CS101", LocalDate.now(), LocalDate.now().plusDays(30), "Mentor1", 50f, LocalDateTime.now(),1f,50L);
    ...
    void getAllCourses_Test() {
        ...
        List<Course> mockCourses = Arrays.asList(
                new Course(1L, "Course1", "CS101", LocalDate.now(), LocalDate.now().plusDays(30), "Mentor1", 50f,LocalDateTime.now(),1f,50L),
                new Course(2L, "Course2", "CS102", LocalDate.now(), LocalDate.now().plusDays(30), "Mentor2", 60f,LocalDateTime.now(),1f,50L)
        );
    ...
    void updateCourse_Test() {
        Long courseId = 1L;
        CourseDto updatedCourseDto = new CourseDto(1L, "UpdatedCourse", "CS101", LocalDate.now(), LocalDate.now().plusDays(30), "UpdatedMentor", 75f,LocalDateTime.now(),1f,50L);
        Course existingCourse = new Course(1L, "Course1", "CS101", LocalDate.now(), LocalDate.now().plusDays(30), "Mentor1", 50f,LocalDateTime.now(),1f,50L);
